...
import HealthNumbersNavigation from "./HealthNumbersNavigation"
import UploadReport from "./HealthReprots/UploadReport"
import HealthReportsAll from "./HealthReprots/HealthReportsAll"
import CameraUpload from "./HealthReprots/CameraUpload"
import UploadTest from "./HealthReprots/UploadTest"
const store = createStore(appReducer);
const currentDate = new Date();
const TabScreen = createMaterialTopTabNavigator(
  {
    Fitness: { screen: Fitness },    
    Numbers: {screen: HealthNumbers},
    Reports: { screen: HealthReports },
  },
  {
    tabBarPosition: 'top',
    swipeEnabled: true,
  ...
  HealthReportsAll: {
    ...
    navigationOptions: ({ navigation }) => ({
      ...
      headerRight: (
        <View>
           <Text
              style={{ paddingRight: 20, color: "white", fontSize: 20 }}
              onPress={() => {                
                }
              }
            >
